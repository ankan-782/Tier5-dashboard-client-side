...
const AddAnotherUser = (props) => {
    ...
    const { addAnotherUser, setError, error, setBackendError, backendError, setSuccess, success } = useAuthValues();
    ...
    const handleAddUser = (e) => {
        ...
        if (inputFieldInfos.password !== inputFieldInfos.confirmPassword) {
            ...
            addAnotherUser(inputFieldInfos.email, inputFieldInfos.username, inputFieldInfos.name, inputFieldInfos.age, inputFieldInfos.gender, inputFieldInfos.country, inputFieldInfos.device, inputFieldInfos.password);
        }
    }
    return (
        <>
                ...
                <div className='min-vh-100 d-flex justify-content-center align-items-center bg-success bg-opacity-10'>
                    <div className='bg-dark bg-opacity-25 add-another-user-content'>
                        <form onSubmit={handleAddUser} className="mb-3">
                            ...
                            <button type='submit' className='form-btn p-3'>Add the User</button>
                        </form>
...
export default withAuthentication(AddAnotherUser);